...
export const DarkLoadingTile = Template.bind({});
DarkLoadingTile.args = {
  isLoading: true,
  typeOfView: TypesOfArticlesView.TILE,
};

DarkLoadingTile.decorators = [ThemeDecorator(Theme.DARK)];

export const BlueLoadingTile = Template.bind({});
BlueLoadingTile.args = {
  isLoading: true,
  typeOfView: TypesOfArticlesView.TILE,
};

BlueLoadingTile.decorators = [ThemeDecorator(Theme.BLUE)];
